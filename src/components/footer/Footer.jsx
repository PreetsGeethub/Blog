        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Share your thoughts and stories with the world. Create, read, and engage with amazing content.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/add-post" className="text-gray-400 hover:text-white transition-colors">
                  Create Post
                </Link>
              </li>
            </ul>
